...
<div class="section" data-aos="fade-up">
    <div class="container">
        ...
        <?php 
            $meal_section_recipe = $meal_section_meta['recipes'];
            $meal_recipe_one     = get_post($meal_section_recipe[1]['recipe']);
            $meal_recipe_two     = get_post($meal_section_recipe[2]['recipe']);
            $meal_recipe_three   = get_post($meal_section_recipe[3]['recipe']);
            ...
            <div class="ftco-46">
                ...
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    ...
                    <div class="ftco-46-text ftco-46-arrow-left">
                        ...
                        <p><a href="<?php echo get_the_permalink($meal_recipe_two); ?>" class="btn-link"><?php echo _e("Learn More","meal")?><span
                ...
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    <div class="ftco-46-text ftco-46-arrow-right">
                        ...
                        <p><a href="<?php echo get_the_permalink($meal_recipe_one); ?>" class="btn-link"><?php echo _e("Learn More","meal")?><span
                                class="ion-android-arrow-forward"></span></a></p>
                    </div>
                    ...
                    <div class="ftco-46-text ftco-46-arrow-up">
                        ...
                        <p><a href="<?php echo get_the_permalink($meal_recipe_three); ?>" class="btn-link"><?php echo _e("Learn More","meal")?><span
                                class="ion-android-arrow-forward"></span></a></p>
                    </div>
                </div>
            </div>
