        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10" data-aos="fade-up">
                    ...
                    <p><a href="<?php echo esc_url($meal_section_meta['button_target']);?>" class="smoothscroll btn btn-outline-white px-5 py-3"><?php echo esc_html($meal_section_meta['button_title']);?> </a></p>
                </div>
            </div>
        </div>
    </div>
